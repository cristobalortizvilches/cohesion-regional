...
labs(x = NULL, y = NULL, 
     title = 'Nivel de pertenencia al barrio según ola',
...
elsoc_long_2016_2022 %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
        ...
        legend.title = element_blank()) +
  labs(x = NULL, y = NULL, 
       title = 'Nivel de pertenencia al barrio según ola y zona',
...
elsoc_long_2016_2022 %>% 
  ...
  mutate(spb = (t02_01 + t02_02 + t02_03 + t02_04)/4,
         ...
         regiones = recode(region, 
                    ...
                    "La araucania" = "La araucanía", "Araucania" = "La araucanía", 
  ...
  filter(spb_rec == 'De acuerdo o\ntotalmente de acuerdo', 
         regiones %in% c("Tarapacá", "Antofagasta", "Atacama", "Maule", "Biobío", "La araucanía", "Ñuble")) %>% 
...
elsoc_long_2016_2022 %>% 
  ...
  geom_text(vjust = -0.8,
            ...
            size = 2.5) +
  labs(x = NULL, y = NULL, 
       title = 'Nivel de apego al barrio según ola y tipo de ciudad',
       subtitle = 'Porcentaje que responde "De acuerdo o totalmente de acuerdo"',
       caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=2.868 (1.503 individuos).\nNota 2: El apego al barrio corresponde a un índice compuesto de cuatro ítems donde se consulta el grado\nde acuerdo con las afirmaciones "Este es el barrio ideal para mi", "Me siento integrado/a en este barrio",\n"Me identifico con la gente de este barrio", "Este barrio es parte de mi".')
...
elsoc_long_2016_2022 %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
        ...
        legend.title = element_blank()) + 
  labs(y = NULL, x = NULL, 
       title = 'Nivel de pertenencia al barrio según quintil de ingresos y ola del estudio', 
       subtitle = 'Porcentaje que responde "De acuerdo o totalmente de acuerdo"',
...
elsoc_long_2016_2022 %>% 
  ...
  facet_wrap(.~ zona1) +
  labs(y = NULL, x = NULL, 
       title = 'Nivel de pertenencia al barrio según ola, quintil y zona', 
       subtitle = 'Porcentaje que responde "De acuerdo o totalmente de acuerdo"',
       caption = 'Fuente: Elaboración propia en base a datos ELSOC 2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=7.308 (1.513 individuos).\nNota 2: La La pertenencia al barrio corresponde a un índice compuesto de cuatro ítems donde se consulta el grado\nde acuerdo con las afirmaciones "Este es el barrio ideal para mi", "Me siento integrado/a en este barrio",\n"Me identifico con la gente de este barrio", "Este barrio es parte de mi".')
```

```{r spb-educ-ams}
elsoc_long_2016_2022 %>% 
  filter(tipo_atricion == 1 & ola %in% 1:6, !is_nsnr(t02_01, t02_02, t02_03, t02_04,m01)) %>% 
  mutate(spb = (t02_01 + t02_02 + t02_03 + t02_04)/4,
         spb_rec = factor(cut(spb, breaks = c(0,2.75,3.75,5)),
                                  labels = c("Totalmente en desacuerdo o\nen desacuerdo","Ni de acuerdo\nni en desacuerdo","De acuerdo o\ntotalmente de acuerdo")),
         estrato = factor(estrato, levels = c(1,2,3,4,5,6),
  ...
  prop(spb_rec, by = c(educ, ola), na.rm = TRUE) %>% 
  filter(spb_rec == "De acuerdo o\ntotalmente de acuerdo") %>% 
  as_label(ola) %>% 
  #filter(quintil %in% c('Quintil 1', 'Quintil 5')) %>% 
  drop_na() %>% 
  ...
  geom_line() +
  theme_bw() +   
  scale_color_viridis_d(begin = .11, end = .99, direction = -1) +
  scale_y_continuous(labels = scales::percent, limits = c(0, 1)) +
  geom_text_repel(size = 3, nudge_y = .01)+
  theme(plot.caption = element_text(hjust = 0),
        legend.position = 'top',
        legend.title = element_blank()) + 
  labs(y = NULL, x = NULL, 
       title = 'Nivel de apego al barrio según nivel educacional y ola del estudio', 
       subtitle = 'Porcentaje que responde "De acuerdo o totalmente de acuerdo"',
       caption = 'Fuente: Elaboración propia en base a datos ELSOC 2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=7.308 (1.513 individuos).\nNota 2: el apego al barrio corresponde a un índice compuesto de cuatro ítems donde se consulta el grado\nde acuerdo con las afirmaciones "Este es el barrio ideal para mi", "Me siento integrado/a en este barrio",\n"Me identifico con la gente de este barrio", "Este barrio es parte de mi".')
...
elsoc_long_2016_2022 %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
        ...
        legend.title = element_blank()) +
labs(x = NULL, y = NULL, 
     title = 'Nivel de sociabilidad barrial según ola',
...
elsoc_long_2016_2022 %>% 
  ...
  geom_text(vjust = -0.8,
            ...
            size = 3) +
  labs(x = NULL, y = NULL, 
       title = 'Nivel de sociabilidad barrial según ola y zona',
       subtitle = 'Porcentaje que responde "De acuerdo o totalmente de acuerdo"',
       caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=2.868 (1.503 individuos).\nNota 2: La sociabilidad barrial corresponde a un índice compuesto de cuatro ítems donde se consulta el grado\nde acuerdo con las afirmaciones "En este barrio es facil hacer amigos", "La gente en este barrio es sociable",\n"La gente en este barrio es cordial", "La gente en este barrio es colaboradora".')
```
```{r soci-ola-region}
elsoc_long_2016_2022 %>% 
  ...
  filter(soci_rec == 'De acuerdo o\ntotalmente de acuerdo', 
         regiones %in% c("Tarapaca", "Antofagasta", "Atacama", "Maule", "Biobío", "La araucanía")) %>% 
  ggplot(aes(y = prop, x = regiones, fill = ola, 
             label = as.character(scales::percent(prop, accuracy = .1)))) + 
  theme_bw() + 
  geom_col(position = 'dodge2') +
  ...
  theme(plot.caption = element_text(hjust = 0),
        ...
        legend.title = element_blank()) +
  labs(x = NULL, y = NULL, 
       title = 'Nivel de sociabilidad barrial según ola y región',
       subtitle = 'Porcentaje que responde "De acuerdo o totalmente de acuerdo"',
       caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=2.868 (1.503 individuos).\nNota 2: La sociabilidad barrial corresponde a un índice compuesto de cuatro ítems donde se consulta el grado\nde acuerdo con las afirmaciones "En este barrio es facil hacer amigos", "La gente en este barrio es sociable",\n"La gente en este barrio es cordial", "La gente en este barrio es colaboradora".')
...
elsoc_long_2016_2022 %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
        ...
        legend.title = element_blank()) + 
  labs(y = NULL, x = NULL, 
       title = 'Nivel de sociabilidad barrial según quintil de ingresos y ola del estudio', 
       subtitle = 'Porcentaje que responde "De acuerdo o totalmente de acuerdo"',
       caption = 'Fuente: Elaboración propia en base a datos ELSOC 2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=7.308 (1.513 individuos).\nNota 2: La sociabilidad barrial corresponde a un índice compuesto de cuatro ítems donde se consulta el grado\nde acuerdo con las afirmaciones "En este barrio es facil hacer amigos", "La gente en este barrio es sociable",\n"La gente en este barrio es cordial", "La gente en este barrio es colaboradora".')
```

```{r soci-ola-quintil-zona}
...
elsoc_long_2016_2022 %>% 
  ...
  facet_wrap(.~ zona1) +
  labs(y = NULL, x = NULL, 
       title = 'Nivel de sociabilidad barrial según ola, quintil y zona', 
       subtitle = 'Porcentaje que responde "De acuerdo o totalmente de acuerdo"',
       caption = 'Fuente: Elaboración propia en base a datos ELSOC 2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=7.308 (1.513 individuos).\nNota 2: La sociabilidad barrial corresponde a un índice compuesto de cuatro ítems donde se consulta el grado\nde acuerdo con las afirmaciones "En este barrio es facil hacer amigos", "La gente en este barrio es sociable",\n"La gente en este barrio es cordial", "La gente en este barrio es colaboradora".')
```
...
elsoc_long_2016_2022 %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
        ...
        legend.title = element_blank()) +
labs(x = NULL, y = NULL, 
     title= 'Confianza en vecinos, según ola de estudio',
     caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=7.529 (1.513 individuos)')
...
elsoc_long_2016_2022 %>% 
  ...
  geom_text(vjust = -0.8,
            ...
            size = 3) + 
  labs(x = NULL, y = NULL, 
       title = 'Confianza en vecinos, según zona geográfica y ola del estudios', 
       subtitle = 'Porcentaje que responde "Bastante o mucho"',
       caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=3.011 (1.513 individuos)')

```
```{r vecinos-ola-region}
elsoc_long_2016_2022 %>% 
  filter(tipo_atricion == 1 & ola %in% 1:6, !t01 %in% c(-888, -999)) %>% 
  mutate(regiones = recode(region, 
                    ...
                    "Valparaiso" = "Valparaíso")) %>% 
  as_label(ola) %>% 
  prop(x = t01 %in% 4:5, by = c(ola, regiones), na.rm = TRUE) %>%
  filter(regiones %in% c("Tarapaca", "Antofagasta", "Atacama", "Maule", "Biobío", "La araucanía")) %>% 
  ggplot(aes(y = prop, x = regiones, fill = ola, 
             label = as.character(scales::percent(prop, accuracy = .1)))) + 
  theme_bw() + 
  geom_col(position = 'dodge2') +
  ...
  theme(plot.caption = element_text(hjust = 0),
        ...
        legend.title = element_blank()) +
  labs(x = NULL, y = NULL, 
        title = 'Confianza en vecinos, según región y ola', 
       subtitle = 'Porcentaje que responde "Bastante o mucho"',
       caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=3.011 (1.513 individuos)')
...
elsoc_long_2016_2022 %>% 
  ...
  geom_text(vjust = -0.8,
            ...
            size = 3) +
  labs(x = NULL, y = NULL, 
       title = 'Confianza en vecinos según tipo de ciudad y ola del estudio', 
       subtitle = 'Porcentaje que responde "Bastante o mucho"',
       caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=3.011 (1.513 individuos)')
...
elsoc_long_2016_2022 %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
        ...
        legend.title = element_blank()) + 
  labs(y = NULL, x = NULL, 
       title = 'Confianza en vecinos, según quintil de ingresos y ola del estudio', 
       subtitle = 'Porcentaje que responde "Bastante o mucho"',
       caption = 'Fuente: Elaboración propia en base a datos ELSOC 2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=7.308 (1.513 individuos)')
```

```{r vecinos-ola-quintil-zona}
...
elsoc_long_2016_2022 %>% 
  ...
  facet_wrap(.~ zona1) +
  labs(y = NULL, x = NULL, 
       title = 'Confianza en vecinos según ola, quintil y zona', 
       subtitle = 'Porcentaje que responde "Bastante o mucho"',
       caption = 'Fuente: Elaboración propia en base a datos ELSOC 2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=7.308 (1.513 individuos)')
```
...
elsoc_long_2016_2022 %>% 
  filter(tipo_atricion == 1 & ola %in% 1:5, !is_nsnr(t04_05)) %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
        ...
        legend.title = element_blank()) +
labs(x  = NULL, y = NULL, 
     title = 'Grado permanencia de lazos fuertes en el barrio según ola',
     caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=7.462 (1.513 individuos).\nNota 2: Los lazos fuertes corresponden a vecinos y amigos del barrio.')
```
...
elsoc_long_2016_2022 %>% 
  ...
  geom_text(vjust = -0.8,
            ...
            size = 3) +
  labs(x = NULL, y = NULL, 
       title = 'Grado permanencia de lazos fuertes  según ola y zona',
       subtitle = 'Porcentaje que responde "De acuerdo o totalmente de acuerdo"',
       caption = "Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=2.868 (1.503 individuos).\nNota 2: Los lazos fuertes corresponden a vecinos y amigos del barrio.")
```
...
elsoc_long_2016_2022 %>% 
  ...
  geom_text(vjust = -0.8,
            ...
            size = 2) +
  labs(x = NULL, y = NULL, 
       title = 'Grado permanencia de lazos fuertes  según ola y tipo de ciudad',
       subtitle = 'Porcentaje que responde "De acuerdo o totalmente de acuerdo"',
       caption = "Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=2.868 (1.503 individuos).\nNota 2: Los lazos fuertes corresponden a vecinos y amigos del barrio.")
...
elsoc_long_2016_2022 %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
        ...
        legend.title = element_blank()) + 
  labs(y = NULL, x = NULL, 
       title = 'Grado permanencia de lazos fuertes  según quintil de ingresos y ola del estudio', 
       subtitle = 'Porcentaje que responde "De acuerdo o totalmente de acuerdo"',
       caption = 'Fuente: Elaboración propia en base a datos ELSOC 2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=7.308 (1.513 individuos).\nNota 2: Los lazos fuertes corresponden a vecinos y amigos del barrio.')
```

```{r lazos-ola-quintil-zona}
elsoc_long_2016_2022 %>% 
  filter(tipo_atricion == 1 & ola %in% 1:4, !is_nsnr(t04_05),
         !is_nsnr(m30, m30b, nhogar1, m46_nhogar, m54)) %>% 
  mutate(
...
elsoc_long_2016_2022 %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
        ...
        legend.title = element_blank()) +
labs(x = NULL, y = NULL, 
     title = 'Membresía a junta de vecinos según ola de estudio',
     caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=7.529 (1.513 individuos)')
...
elsoc_long_2016_2022 %>% 
  ...
  geom_text(vjust = -0.8,
            ...
            size = 3) +
labs(x = NULL, y = NULL, 
     title = 'Miembros activos a junta de vecinos, según tipo de ciudad y ola del estudio', 
     caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=3.011 (1.513 individuos)')
```


```{r membresia-ola-quintil}
elsoc_long_2016_2022 %>% 
  ...
  filter(c12_01 == "Miembro activo",
         quintil %in% c('Quintil 1', 'Quintil 5')) %>% 
  ggplot(aes(y = prop, x = ola, color = quintil, group = quintil,
             label = scales::percent(prop, .1))) +
  geom_point(size = 1.75) + 
  geom_line() +
  ...
  theme(plot.caption = element_text(hjust = 0),
        ...
        legend.title = element_blank()) +
labs(x = NULL, y = NULL, 
     title = 'Miembros activos a junta de vecinos según quintil y ola del estudio', 
     caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=3.011 (1.513 individuos)')

```

```{r membresia-ola-quintil-zona}
elsoc_long_2016_2022 %>% 
  filter(tipo_atricion == 1, !is_nsnr(c07_01),
         !is_nsnr(m30, m30b, nhogar1, m46_nhogar, m54)) %>% 
  mutate(zona1 = factor(car::recode(region_cod, 
  ...
  facet_wrap(.~ zona1) +
labs(x = NULL, y = NULL, 
     title = 'Miembros activos a junta de vecinos, según ola, quintil y zona', 
     caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=3.011 (1.513 individuos)')
...
elsoc_long_2016_2022 %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
        ...
        legend.title = element_blank()) +
labs(x = NULL, y = NULL, 
     title = 'Frecuencia de visita a vecinos según ola de estudio',
     caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=7.557 (1.513 individuos).\nNota 2: La frecuencia de visitas se pregunta con referencia a los últimos 12 meses.')
...
elsoc_long_2016_2022 %>% 
  ...
  geom_text(vjust = -0.8,
            ...
            size = 3) + 
  labs(x = NULL, y = NULL, 
       title = 'Frecuencia de visita a vecinos según zona geográfica', 
       subtitle = 'Porcentaje que visitó una o más veces',
       caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=3.011 (1.513 individuos).\nNota 2: La frecuencia de visitas se pregunta con referencia a los últimos 12 meses.')

```

```{r frecvisita-estrato}
...
elsoc_long_2016_2022 %>% 
  ...
  geom_text(vjust = -0.8,
            ...
            size = 3) +
  labs(x = NULL, y = NULL, 
       title = 'Frecuencia de visita a vecinos según estrato',
       subtitle = 'Porcentaje que visitó una o más veces',
       caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=3.011 (1.513 individuos).\nNota 2: La frecuencia de visitas se pregunta con referencia a los últimos 12 meses.')

```

```{r frecvisita-quintil}
...
elsoc_long_2016_2022 %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
        ...
        legend.title = element_blank()) + 
  labs(y = NULL, x = NULL, 
       title = 'Frecuencia de visita a vecinos por ola y quintil',
       subtitle = 'Porcentaje que visitó una o más veces',
       caption = 'Fuente: Elaboración propia en base a datos ELSOC 2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=7.308 (1.513 individuos).\nNota 2: La frecuencia de visitas se pregunta con referencia a los últimos 12 meses.')
```

```{r frecvisita-ola-quintil-zona}
...
elsoc_long_2016_2022 %>% 
  ...
  facet_wrap(.~ zona1) +
  labs(y = NULL, x = NULL, 
       title = 'Frecuencia de visita a vecinos por ola, quintil y zona',
       subtitle = 'Porcentaje que visitó una o más veces',
       caption = 'Fuente: Elaboración propia en base a datos ELSOC 2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=7.308 (1.513 individuos).\nNota 2: La frecuencia de visitas se pregunta con referencia a los últimos 12 meses.')
```